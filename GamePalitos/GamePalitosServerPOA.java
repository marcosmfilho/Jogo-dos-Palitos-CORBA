 ...
 implements GamePalitos.GamePalitosServerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("recebePalpite", new java.lang.Integer (4));
    _methods.put ("verificaPalpites", new java.lang.Integer (5));
    _methods.put ("somaPalitos", new java.lang.Integer (6));
    _methods.put ("alteraTurno", new java.lang.Integer (7));
    _methods.put ("reiniciaValores", new java.lang.Integer (8));
    _methods.put ("retiraUmPalito", new java.lang.Integer (9));
    _methods.put ("verificaVenceu", new java.lang.Integer (10));
    _methods.put ("buscaQuantidadePalitos", new java.lang.Integer (11));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // GamePalitos/GamePalitosServer/recebePalpite
       {
         String nomeCliente = in.read_string ();
       ...
       case 5:  // GamePalitos/GamePalitosServer/verificaPalpites
       {
       ...
       case 6:  // GamePalitos/GamePalitosServer/somaPalitos
       {
         int palitos = in.read_long ();
       ...
       case 7:  // GamePalitos/GamePalitosServer/alteraTurno
       {
         this.alteraTurno ();
         out = $rh.createReply();
         break;
       ...
       case 8:  // GamePalitos/GamePalitosServer/reiniciaValores
       {
       ...
       case 9:  // GamePalitos/GamePalitosServer/retiraUmPalito
       {
         String nomeCliente = in.read_string ();
       ...
       case 10:  // GamePalitos/GamePalitosServer/verificaVenceu
       {
         String nomeCliente = in.read_string ();
       ...
       case 11:  // GamePalitos/GamePalitosServer/buscaQuantidadePalitos
       {
         String nomeCliente = in.read_string ();
         int $result = (int)0;
