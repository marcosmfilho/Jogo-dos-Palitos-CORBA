...
public class _GamePalitosServerStub extends org.omg.CORBA.portable.ObjectImpl implements GamePalitos.GamePalitosServer
{
  ...
  public void mensagemBroadCast (String mensagem, boolean quebraDelinha)
  {
            ...
            try {
                ...
                $out.write_boolean (quebraDelinha);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                mensagemBroadCast (mensagem, quebraDelinha        );
            } finally {
                _releaseReply ($in);
            }
  } // mensagemBroadCast
  ...
  public void mensagemBroadCastNoJogo (String mensagem, boolean quebraDelinha)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("mensagemBroadCastNoJogo", true);
                $out.write_string (mensagem);
                $out.write_boolean (quebraDelinha);
                $in = _invoke ($out);
                return;
                ...
                mensagemBroadCastNoJogo (mensagem, quebraDelinha        );
            } finally {
                _releaseReply ($in);
            }
  ...
  public boolean verificaEstaNoJogo (String nomeCliente)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("verificaEstaNoJogo", true);
                $out.write_string (nomeCliente);
                $in = _invoke ($out);
                ...
                return verificaEstaNoJogo (nomeCliente        );
            } finally {
                _releaseReply ($in);
            }
  } // verificaEstaNoJogo
  ...
  public boolean palpiteValido (int palpite)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("palpiteValido", true);
